 ...
 * means the backend works without any external database.
 *
 * To add a new storage backend, create a sibling folder
 * `dataModel/storage/<name>/` whose classes implement the same
 * repository interfaces, then add a switch case in `dataModel/index.ts`.
 *
